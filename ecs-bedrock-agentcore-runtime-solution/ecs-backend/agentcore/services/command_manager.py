...
from agentcore.models.strands_models import StrandsAgentResponse
...
class CommandManager(CommandManagerInterface):
    ...
    def _get_agentcore_ssm_prefix(self) -> str:
        ...
        try:
            ...
            fallback_prefix = get_dynamic_parameter_prefix()
            return f"/{fallback_prefix}/agentcore"  # Fallback to dynamic prefix
