#!/usr/bin/env python3
"""Deploy the AgentCore Long-Running Orchestrator with Memory stack (multi-phase)."""
import argparse
import boto3
import os
import sys
...
def get_args():
    parser = argparse.ArgumentParser(description="Deploy AgentCore Long-Running Orchestrator with Memory")
    parser.add_argument("--stack-name", default="agentcore-longrun-memory", help="CloudFormation stack name")
